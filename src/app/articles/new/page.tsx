...
const CreateBlogPage = () => {
  ...
  return (
    <div className='min-h-screen py-8 px-4 md:px-12'>
      ...
      <form className='font-bold mb-2 bg-slate-200 p-6 rounded shadow-lg' onSubmit={handleSubmit}>
        <div className='mb-4'>
            <label className='text-gray-600 text-sm font-bold mb-2'>URL</label>
        ...
        <div className='mb-4'>
            <label className='text-gray-600 text-sm font-bold mb-2'>タイトル</label>
        ...
        <div className='mb-4'>
            <label className='text-gray-600 text-sm font-bold mb-2'>本文</label>
        ...
        <button type="submit" className={`py-2 px-4 border rounded-md ${loading ? "bg-orange-300 cursor-not-allowed w-16 h-16 border-t-4 rounded-full animate-spin" :"bg-orange-400 hover:bg-orange-500"}`} disabled={loading}>投稿</button>
      </form>
    </div>
  )
}
